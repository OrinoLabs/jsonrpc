    ...
    dispatchCall(methodName, params) {
        return new Promise((resolve, reject) => {
            ...
            if (!handler) {
                ...
                reject(new jsonrpcerror_js_1.JsonRpcError(jsonrpcerror_js_1.ErrorCode.METHOD_NOT_FOUND, undefined, methodName));
                return;
            }
            let resultPromise;
            try {
            ...
            resultPromise
                ...
                if (err instanceof jsonrpcerror_js_1.JsonRpcError) {
                    reject(err);
                }
                else {
                    reject(new jsonrpcerror_js_1.JsonRpcError(jsonrpcerror_js_1.ErrorCode.APPLICATION_ERROR, undefined, err));
                }
            });
        });
    }
